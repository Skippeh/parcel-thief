...
CREATE INDEX account_histories_encountered_at_idx ON account_histories (encountered_at DESC);

CREATE UNIQUE INDEX account_histories_account_id_encountered_id_idx ON account_histories (account_id, encountered_id);
