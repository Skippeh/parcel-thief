...
-- Drop null index
DROP INDEX qpid_object_construction_materials_object_id_null_contributor_id_idx;

-- Drop the new index
DROP INDEX qpid_object_construction_materials_object_id_contributor_id_idx;

-- Rename contributor_id to contributor
ALTER TABLE
    qpid_object_construction_materials RENAME COLUMN contributor_id TO contributor;